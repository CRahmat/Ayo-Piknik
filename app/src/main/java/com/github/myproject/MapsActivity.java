        ...
        switch (view.getId()) {
            case R.id.search_address:
                ...
                if (!TextUtils.isEmpty(address)) {
                    ...
                    Toast.makeText(this, "Tulis Lokasi yang dicari ...", Toast.LENGTH_SHORT).show();
                }
                break;
            ...
            case R.id.vacation_nearby:
                ...
                Toast.makeText(this, "Mencari Wisata Terdekat...", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Menampilkan Wisata Terdekat...", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.hotel_nearby:
                ...
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Mencari Hotel Terdekat...", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Menampilkan Hotel Terdekat...", Toast.LENGTH_SHORT).show();
                break;
            ...
            case R.id.restaurant_nearby:
                ...
                getNearbyPlaces.execute(transferData);
                Toast.makeText(this, "Mencari Restaurant Terdekat...", Toast.LENGTH_SHORT).show();
                Toast.makeText(this, "Menampilkan Restaurant Terdekat...", Toast.LENGTH_SHORT).show();
                break;
        }
    }
