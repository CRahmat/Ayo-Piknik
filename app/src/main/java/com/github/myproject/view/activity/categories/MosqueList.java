...
import com.github.myproject.adapter.activity_adapter.MosqueListAdapter;
import com.github.myproject.model.PlacesResultsItem;
import com.github.myproject.view_model.MosqueListViewModel;
...
public class MosqueList extends AppCompatActivity {
    ...
    private MosqueListViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.mosque_list_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter = new MosqueListAdapter(this);
        adapter.notifyDataSetChanged();

        recyclerView.setAdapter(adapter);

        viewModel = new ViewModelProvider(this).get(MosqueListViewModel.class);
        viewModel.setModelHotel();
        viewModel.getModelHotel().observe(this, getModel);

        editTextSearch = findViewById(R.id.mosque_list_search_bar);
