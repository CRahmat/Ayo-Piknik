...
import com.github.myproject.adapter.activity_adapter.StationListAdapter;
import com.github.myproject.model.PlacesResultsItem;
import com.github.myproject.view_model.TrainStationListViewModel;
...
public class TrainstationList extends AppCompatActivity {
    ...
    private TrainStationListViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trainstation_list);
        ...
        viewModel = new ViewModelProvider(this).get(TrainStationListViewModel.class);
        viewModel.setModelHotel();
        viewModel.getModelHotel().observe(this, getModel);

        editTextSearch = findViewById(R.id.train_list_search_bar);
