...
import com.github.myproject.adapter.activity_adapter.ATMListAdapter;
import com.github.myproject.model.PlacesResultsItem;
import com.github.myproject.view_model.ATMListViewModel;
...
public class AtmList extends AppCompatActivity {
    ...
    private ATMListViewModel viewModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.atm_list_recycler_view);
        recyclerView.setLayoutManager(new LinearLayoutManager(this));

        adapter = new ATMListAdapter(this);
        adapter.notifyDataSetChanged();

        recyclerView.setAdapter(adapter);

        viewModel = new ViewModelProvider(this).get(ATMListViewModel.class);
        viewModel.setModelHotel();
        viewModel.getModelHotel().observe(this, getModel);

        editTextSearch = findViewById(R.id.atm_list_search_bar);
