...
import com.github.myproject.adapter.activity_adapter.BankListAdapter;
import com.github.myproject.model.PlacesResultsItem;
import com.github.myproject.view_model.BankListViewModel;
...
public class BankList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.bank_list_recycler_view);
        ...
        viewModel = new ViewModelProvider(this).get(BankListViewModel.class);
        viewModel.setModelHotel();
        viewModel.getModelHotel().observe(this, getModel);

        editTextSearch = findViewById(R.id.bank_list_search_bar);
