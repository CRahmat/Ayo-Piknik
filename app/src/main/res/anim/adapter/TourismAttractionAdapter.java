package com.example.tourisminformationcenter.adapter;
...
import com.example.tourisminformationcenter.R;
import com.example.tourisminformationcenter.model.PlacesResultsItem;
...
public class TourismAttractionAdapter extends RecyclerView.Adapter<TourismAttractionAdapter.ViewHolder> implements Filterable {
    ...
    @Override
    public void onBindViewHolder(@NonNull TourismAttractionAdapter.ViewHolder holder, final int position) {
